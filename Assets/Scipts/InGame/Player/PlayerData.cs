...
public class PlayerData : MonoBehaviour
{
    ...
    */
    ...
    public IEnumerator UseReward(string name)
    {
        ...
        {
            float recoverHp = maxHp * 0.4f;
            RecoverCurentHp(recoverHp);
        }
        ...
        else if (name.Equals("coin"))
        {
            ...
            {
                GameObject ExpClone = Instantiate(ItemExp,Player.transform.position, transform.rotation);
