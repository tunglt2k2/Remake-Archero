...
public class SlotMachineMgr : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        {
            resultText[i].text = "";
            SlotSkillObject[i].transform.localPosition = new Vector3(0, 384f, 0);
        }
    ...
    IEnumerator StartSlot(int SlotIndex)
    {
        ...
        {
            SlotSkillObject[SlotIndex].transform.localPosition -= new Vector3(0, 64f, 0);
            if (SlotSkillObject[SlotIndex].transform.localPosition.y < 64f)
            {
                SlotSkillObject[SlotIndex].transform.localPosition += new Vector3(0, 384f, 0);
            }
